...
class contactsTableView: UITableView, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            self.selectionDelegate!.handleSelectOfUser(selectedContact: contactsOnWandr[indexPath.item])
        case 2:
            break
        default:
            break
    ...
    func getTableData(complete: @escaping ()->()) {
        ...
        FirebaseFunctions().getContacts { (contacts) in
...
class activeContactCell: UITableViewCell {
    ...
    var contact: SelectableContact! {
        didSet {
            ...
            if contact.userData != nil {
                contactCellView.profileImage.setImage(urlstring: contact.userData!.profileImageURL, size: contactCellView.profileImage.frame.size) {
