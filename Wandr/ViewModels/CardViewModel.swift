...
let cardViewModels: [CardViewModel] = {
    ...
    let producers = [
        ...
        Concert(name: "Post Malone with Swae Lee and Tyla Yaweh", city: "Landover, MD", distance: 31.5, cover_photo: "concert", date: "Sep 12", start_time: "8:00", venue: "FedEx Field – Washington"),
