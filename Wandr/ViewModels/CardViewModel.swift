...
class CardViewModel {
    ...
    init(placeImages: [String], headerText: NSAttributedString, topRowText: NSAttributedString, bottomRowText: NSAttributedString, pricing: Pricing, rating: CGFloat) {
        self.placeImages = placeImages; self.headerText = headerText; self.topRowText = topRowText; self.bottomRowText = bottomRowText; self.pricing = pricing; self.rating = rating;
    }
